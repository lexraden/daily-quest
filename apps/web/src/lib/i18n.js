...
const translations = {
  ru: {
    ...
    premium: {
      ...
      freeRemindersDesc: 'Push и Telegram',
      buyFor: 'Оформить Pro',
    ...
    notifications: {
      ...
      pushOffHint: 'Без этого напоминания видны только в приложении.',
  ...
  en: {
    ...
    premium: {
      ...
      freeRemindersDesc: 'Push and Telegram',
      buyFor: 'Get Pro',
    ...
    notifications: {
      ...
      pushOffHint: 'Without this, reminders only show up in the app.',
