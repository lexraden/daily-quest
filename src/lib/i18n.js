...
const translations = {
  ru: {
    ...
    calories: {
      ...
      analyzingSteps: [
        ...
        'Распознаю блюда...',
        'Считаю калории...',
        'Определяю белки и жиры...',
        'Подсчитываю углеводы...',
        'Финальная проверка...'
      ],
      caloriesIn: 'Съедено',
      caloriesOut: 'Сожжено',
      connectIntegration: 'Подключить',
      integrationTitle: 'Подключить трекер активности',
      integrationDesc: 'Apple Health, Google Fit и Fitbit поддерживаются только в нативных мобильных приложениях. В веб-версии прямое подключение недоступно.',
      integrationFitbit: 'Fitbit (через OAuth) — скоро',
      integrationManual: 'Ручной ввод — скоро',
      integrationSoon: 'Эта функция в разработке',
  ...
  en: {
    ...
    calories: {
      ...
      integrationTitle: 'Connect activity tracker',
      integrationDesc: 'Apple Health, Google Fit and Fitbit are supported only in native mobile apps. Direct connection is not available in the web version.',
      integrationFitbit: 'Fitbit (via OAuth) — soon',
      integrationManual: 'Manual entry — soon',
      integrationSoon: 'This feature is in development',
