...
const translations = {
  ru: {
    ...
    calories: {
      ...
      analyzeSteps: ['Загружаю фото...', 'Распознаю блюдо...', 'Считаю калории...', 'Считаю белки и жиры...', 'Почти готово...'],
  ...
  en: {
    ...
    calories: {
      ...
      analyze: 'Analyze',
      analyzeSteps: ['Uploading photos...', 'Identifying food...', 'Counting calories...', 'Calculating macros...', 'Almost done...'],
      addPhoto: 'Add photo',
