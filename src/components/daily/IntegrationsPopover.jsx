...
import { Link2, X, Heart, Activity, Watch } from 'lucide-react';
...
export default function IntegrationsPopover({ theme = 'light' }) {
  ...
  return (
    <>
      ...
      >
        <Link2 className={`w-3.5 h-3.5 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`} />
      </button>
          ...
          >
            ...
            <div className={`flex items-center justify-between p-5 border-b ${
              ...
              <div className="flex items-center gap-2">
                <Link2 className={`w-5 h-5 ${theme === 'light' ? 'text-purple-600' : 'text-purple-400'}`} />
